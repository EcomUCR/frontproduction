  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="mx-auto max-w-[80rem] w-full">
        {/* 🔙 Botón volver */}
        <section className="flex px-4 sm:px-10 pt-6 font-quicksand">
          <ButtonComponent
          ...
          <>
            {product && (
              <>
                ...
                <section
                  className="
                    flex flex-col sm:flex-row px-4 sm:px-10 pt-5 font-quicksand
                    gap-10 sm:gap-0
                  "
                >
                  {/* 🖼️ Imagen */}
                  <div className="sm:w-3/12 w-full pt-5 sm:pt-10">
                    ...
                    {/* ❤️ Botones */}
                    <div className="border-t-2 border-main pt-6 sm:pt-10">
                      <div className="flex relative border border-contrast-secondary rounded-full px-3 py-2">
                        ...
                        <div className="absolute left-15 top-30">
                          <ul className="flex gap-3">
                            <li className={`relative bottom-10 left-27 bg-main hover:bg-sky-500 p-2 rounded-full text-white transform transition-all duration-300 shadow-md delay-0 ${isModalOpen ? "scale-100" : "scale-0"}`}><IconLink /></li>
                            <li className={`relative bottom-0 left-24 bg-main hover:bg-green-600 p-2 rounded-full text-white transform transition-all duration-300 shadow-md delay-50 ${isModalOpen ? "scale-100" : "scale-0"}`}><IconBrandWhatsapp /></li>
                            <li className={`relative -bottom-1 left-24 bg-main hover:bg-blue-600 p-2 rounded-full text-white transform transition-all duration-300 shadow-md delay-100 ${isModalOpen ? "scale-100" : "scale-0"}`}><IconBrandFacebook /></li>
                            <li className={`relative bottom-5 left-23 bg-main hover:bg-orange-500 p-2 rounded-full text-white transform transition-all duration-300 shadow-md delay-150 ${isModalOpen ? "scale-100" : "scale-0"}`}><IconBrandInstagram /></li>
                            <li className={`relative bottom-17 left-15 bg-main hover:bg-rose-500 p-2 rounded-full text-white transform transition-all duration-300 shadow-md delay-200 ${isModalOpen ? "scale-100" : "scale-0"}`}><IconBrandTiktok /></li>
                            <li className={`relative bottom-30 -left-1 bg-main hover:bg-black p-2 rounded-full text-white transform transition-all duration-300 shadow-md delay-250 ${isModalOpen ? "scale-100" : "scale-0"}`}><IconBrandX /></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                  ...
                  {/* 🔹 Columna central */}
                  <div className="sm:w-6/12 w-full sm:px-20 border-r-0 sm:border-r-2 border-main sm:mr-5">
                    ...
                    >
                      ...
                      <ButtonComponent
                        ...
                        style="hidden sm:block pr-6 text-main-dark/50 hover:text-main hover:font-semibold"
                      />
                    </div>

                    <div>
                      {activeTab === "description" && (
                        <p className="whitespace-pre-line overflow-y-auto p-5 relative h-auto sm:h-80">
                          {product.description || "Sin descripción."}
                        </p>
                      )}
                      {activeTab === "reviews" && (
                        <p className="whitespace-pre-line overflow-y-auto p-6 relative h-auto sm:h-80">
                          Este producto aún no tiene calificaciones.
                        </p>
                      )}
                      {activeTab === "details" && (
                        <p className="whitespace-pre-line overflow-y-auto p-6 relative h-auto sm:h-80 hidden sm:block">
                ...
                <section className="my-10 px-4 sm:px-10">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 my-10 gap-5">
                    {similarProducts.length > 0 ? (
                      ...
                      <p className="col-span-full text-center text-sm text-gray-500 font-quicksand">
