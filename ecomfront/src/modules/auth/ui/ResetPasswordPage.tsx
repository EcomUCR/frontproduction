                    ...
                    <div className="flex flex-col items-center w-full justify-center">
                        ...
                        <div className='flex flex-col w-full items-center space-y-5 mt-10'>
                            <form className="flex flex-col items-center w-full space-y-5" action="">
                                <input className='border-2 border-contrast-secondary text-contrast-secondary rounded-full px-4 py-3 w-[45%] font-quicksand' placeholder='Nueva contraseña' type="text" />
                                <input className='border-2 border-contrast-secondary text-contrast-secondary rounded-full px-4 py-3 w-[45%] font-quicksand' placeholder='Confirmar contraseña' type="password" />
                                <button className='bg-contrast-secondary text-white rounded-full py-3 px-4 w-[30%] font-quicksand'>Actualizar contraseña</button>
                            </form>
                        </div>
                    </div>
                </div>
